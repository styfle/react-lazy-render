(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["LazyRender"] = factory(require("react"), require("react-dom"));
	else
		root["LazyRender"] = factory(root["React"], root["ReactDOM"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var elementSize = __webpack_require__(16);
	...
	var LazyRender = createReactClass({
	  ...
	  onScroll: function () {
	    ...
	    var childrenBottom = childrenLength - childrenTop - this.state.childrenToRender;
	  ...
	  componentWillReceiveProps: function (nextProps) {
	    ...
	    var height = this.getHeight(childrenLength, childHeight, nextProps.maxHeight);
	  ...
	  componentDidMount: function () {
	    ...
	    var height = this.getHeight(childrenLength, childHeight, this.props.maxHeight);
	  ...
	  render: function () {
	    ...
	    children.unshift(React.createElement('div', { style: { height: this.state.childrenTop * childHeight }, key: 'top' }));

	    children.push(React.createElement('div', { style: { height: childrenBottom * childHeight }, key: 'bottom' }));
